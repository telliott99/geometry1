...
$\triangle ACR$ and $\triangle ANR$ are both right triangles containing an acute angle which is one-half of $\angle A$.  They share $AR$, so they are congruent.  Thus $CR = NR$ and $\angle NCR = \angle RNC$.
