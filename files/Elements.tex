...
In $\triangle ABC$ extend side $AB$ to $D$.  We are concerned with the exterior $\angle EBD$.

The claim is that $\angle EBD$ is greater (larger) than either of the interior angles $\angle ACB$ or $\angle CAB$.
...
Thus $\angle ACE = \angle FBE$ by the converse of alternate interior angles.

Since the whole is greater than the part, $\angle EBD > \angle FBE = \angle ACE$.

\begin{center} \includegraphics [scale=0.4] {EI_16.png} \end{center}

But also, $AC \parallel BF$ by by the converse of alternate interior angles.

So $\angle CAB = \angle FBD$ by alternate interior angles.

Again, the whole is greater than the part, $\angle EBD > \angle FBD= \angle CAB$.
...
But $\angle CDA$ is the external angle for $\triangle ABD$ so it is greater than $B$.
...
We are given $A > B$ and claim that $BC > AC$.
...
Then by Euclid I.18 just above, we have that $B > A$.

However, this also contradicts what was given.  We must have $A > B$.
...
Then $D$ is smaller than $\angle DAC$ and therefore, by Euclid I.19 just above, $AC$ is less than $DC$.  
...
Here is a different proof that we showed in the first book.

\subsection*{Triangle inequality by circles}

\emph{Proof}.

Consider $\triangle ABC$.  Draw circle $\mathcal{C}_1$ on center $B$ with radius $AB$ and also circle $\mathcal{C}_2$ on center $A$ with radius $AC$.  The third vertex $C$ lies on the intersection of the two circles.  
\begin{center} \includegraphics [scale=0.2] {tri_ineq1} \end{center}

If $AB$ is longer (greater) than the sum of the two radii, then the circles will not cross one another. 

If $AB$ is equal to this sum, then they only touch, on the line $AB$.  Thus, in order for there to be a triangle, $AB$ must be less than the sum of the diameters:  $AB < AC + BC$.  
...
We have $\triangle ABC$ with sides $a$ and $c$ flanking $\theta$ and $\triangle ZBC$ with sides $a$ and $c$ flanking $\phi$, and $\theta < \phi$.  We claim that side $b$ in $\triangle ABC$ is smaller than side $d$ in $\triangle ZBC$.
