...
Recall that the circumcenter is the center of the circle that contains all three vertices, and it can be found by erecting the perpendicular bisectors of the sides.  Side $a$ opposite $A$ is bisected at $K$, while side $c$ opposite $C$ is bisected at $M$.  The perpendicular bisectors meet at $O$.
...
Suppose the small triangle has sides $a,b,c$ and the larger triangle has sides $A,B,C$ with $A/a = B/b = k$.  Suppose that $\gamma$ flanked by $a$ and $b$ is also flanked by $A$ and $B$.
