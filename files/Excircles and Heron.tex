...
Another way to see this is that the external angle at $B$ is equal to $\angle A$ plus $\angle C$, so $\angle I_a BD$ is one-half that.  Since $\triangle I_a DB$ is right, it follows that $\angle B I_a D$ is one-half $\angle B$.  
