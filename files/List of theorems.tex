...
The geometry book has recently been split into parts.  The parts are numbered Python-fashion, starting from \textbf{geometry0} through \textbf{geometry2}.

If a proof is listed here but the link is broken, it's very likely to be in a different volume.  I have left the those in for reference.
