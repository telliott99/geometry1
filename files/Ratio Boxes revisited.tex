...
We look at Ratio Boxes some more, and introduce the topic of inversive geometry.
...
Since $P$ and $P'$ are related by the same transformation, we have $OA \cdot OA' = OP \cdot OP'$.  Since $O$ is shared, we again have similar triangles:  $\triangle OAP \sim \triangle OP'A'$.
...
\begin{center} \includegraphics [scale=0.20] {frustum.png} \end{center}

It's known, and we discuss elsewhere a proof, that the volume of a cone or pyramid is 
\[ V = \frac{1}{3} \ \cdot hA \]
...
This is our ratio box for the problem.  The height of the small missing piece is 
\[ H - h = \frac{b}{a} H \]
