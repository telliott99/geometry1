...
Suppose that $\alpha$ is one-half $\beta$.  Then the chord corresponding to $\alpha$ or the sine of $\alpha$ is \emph{more than} one-half the corresponding value for $\beta$.
