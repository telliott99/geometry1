...
For example, draw $DE$ forming $\triangle CDE$.  We can show that $\triangle DEC \sim \triangle ABC$ with $\angle A = \angle CDE$.
...
$\angle A$ cuts arc BD + DE

$\angle B$ cuts arc AE + DE

$\angle C$ cuts arc AB - DE

$\angle BDE$ cuts arc AB + AE, but this is equal to $\angle B + \angle C$.

$\angle CDE$ is supplementary to $\angle BDE$.  Thus $\angle CDE = \angle A$, and the result follows.  The same is true for any pair of altitudes.
...
Consider the foot of the altitude $AD$ at $D$.  By the lemma, we have that $\triangle DEC \sim \triangle DBF \sim \triangle ABC$.  In particular, $\angle CDE = \angle A = \angle BDF$.

(This is easy to see if we notice that $\angle CDE$ cannot be equal to $\angle B$, because $DE$ is not parallel to the base $AB$).

It follows that the internal $\angle ADE$ and $\angle ADF$ are both complementary to $\angle A$, so they are equal.  Thus $AD$ bisects $\angle EDF$.
...
$\angle ADE$ is complementary to $\angle CDE$ because of the right angle formed at $D$, but $\angle ADE = \angle ABE$ and $\angle ABE$ is complementary to $\angle A$.

Thus, $\angle CDE = \angle A$.
